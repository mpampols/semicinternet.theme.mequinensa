...
from semicinternet.theme.mequinensa import mequinensaMessageFactory as _
...
class IThemeSpecific(IDefaultPloneLayer):
	"""Marker interface that defines a Zope 3 browser layer.
	   ...
	   "SEMIC Internet Mequinensa Theme" theme, this interface must be its layer
	   (in theme/mequinensa/viewlets/configure.zcml).
	"""
...
class IMequinensaSettings(Interface):
	"""Global mequinensa settings. This describes records stored in the configuration 
