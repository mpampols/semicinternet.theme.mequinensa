...
from semicinternet.theme.mequinensa.browser.interfaces import IHomepage

from zope.component import getUtility 
from plone.registry.interfaces import IRegistry 
from semicinternet.theme.mequinensa.browser.interfaces import IMequinensaSettings
...
class Homepage(BrowserView):
    ...
    def getDropDownMenuLevels(self):
        ...
        settings = registry.forInterface(IMequinensaSettings)
