...
Introduction
------------
Mequinensa is a simple, clean and robust Plone 4 Theme based on Sunburst Theme, it has been build to validate both, CSS 3 and XHTML 1.0 Strict code, and to provide a quick way to create new websites without deep technical knowledge.
...
portal_skins/mequinensa_styles/base_properties
